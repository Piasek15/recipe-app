...
import pl.piasecki.services.IngredientService;
import pl.piasecki.services.RecipeService;
import pl.piasecki.services.UnitOfMeasureService;
...
public class IngredientController {
    ...
    public String saveOrUpdate(@ModelAttribute IngredientCommand command){
        IngredientCommand savedComand = ingredientService.saveIngredientCommand(command);
        log.debug("saved recipe id: " + savedComand.getRecipeId());
        log.debug("saved ingredient id: " + savedComand.getId());
        return "redirect:/recipe/" + savedComand.getRecipeId() + "/ingredient/" + savedComand.getId() + "/show";
    }

    @GetMapping("/recipe/{recipeId}/ingredient/{id}/delete")
    public String deleteRecipeIngredient(@PathVariable String recipeId, @PathVariable String id){
        log.debug("Ingredient deleting Id: " + id + " from Recipe of Id: " + recipeId);
